...
const FormsRegisterUpdate = ({razas, categorias, generos,registraPets, onChange, onSubmit}) => {
  return (
    <form onSubmit={onSubmit}>
      <div className='divs-input-select'>
        ...
        <Inputs type="file" name="imagen" placeholder="Subir foto" onChange={onChange} value={registraPets.imagen} className='input inputFile' />
...
export default FormsRegisterUpdate;
